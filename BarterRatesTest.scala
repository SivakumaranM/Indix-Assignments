...
class barterRatesTest extends FlatSpec with Matchers {
  ...
  "BarterRates" should "return the correct barter relations for the given queries" in {
   ...
   "BarterRates" should "create a set of the elements specified in the input barter relations" in {
     barterRates.createSet(Array("! 6 apple = 15 banana", "! 47 grape = 9 mango", "! 2 banana = 1 grape"), Set[String](), 0, 3) should be (Set("apple", "banana", "grape", "mango"))
   }
